...
db_url: str = cfg.db_uri  # EDITED
parent_folder_name: str = "database"  # EDITED
folder_name: str = "schemas"  # EDITED

# Specify the path to your schemas directory  # EDITED
models_dir = os.path.join(os.path.dirname(
    __file__), "..", parent_folder_name, folder_name)  # EDITED
...
for module_info in pkgutil.iter_modules([models_dir]):  # EDITED
    importlib.import_module(
        f"{parent_folder_name}.{folder_name}.{module_info.name}")  # EDITED
...
# target_metadata = None  # EDITED
target_metadata = SQLModel.metadata  # EDITED
